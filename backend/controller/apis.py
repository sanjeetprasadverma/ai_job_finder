...
HELP_TEXT = (
    "🤖 *Job Finder Bot*\n\n"
    "Just type what kind of job you're looking for, and I'll search for matching postings.\n\n"
    "*Examples:*\n"
    "• `python developer remote`\n"
    "• `data analyst bangalore`\n"
    "• `senior react engineer`\n\n"
    "I'll show you one job at a time as a card — use the *◀ Prev* / *Next ▶* buttons "
    "below each result to page through matches.\n\n"
    "*Commands:*\n"
...
async def handle_command(chat_id, text):
    command = text.split()[0].lower().lstrip("/").split("@")[0]  # strips args and @BotName
    ...
    if command in ("start", "help"):
        ...
        await send_message(
            chat_id,
            "Unknown command. Type /help to see how to use this bot."
        )
